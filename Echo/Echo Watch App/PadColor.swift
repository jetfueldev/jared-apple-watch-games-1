...
enum PadColor: Int, CaseIterable, Identifiable {
    ...
    var glassColor: Color {
        switch self {
        case .red:    return Color(red: 0.85, green: 0.2, blue: 0.2).opacity(0.15)
        case .blue:   return Color(red: 0.2, green: 0.4, blue: 0.9).opacity(0.15)
        case .yellow: return Color(red: 0.9, green: 0.8, blue: 0.2).opacity(0.15)
        case .green:  return Color(red: 0.2, green: 0.75, blue: 0.3).opacity(0.15)
        case .orange: return Color(red: 0.95, green: 0.5, blue: 0.15).opacity(0.15)
        case .purple: return Color(red: 0.6, green: 0.25, blue: 0.85).opacity(0.15)
